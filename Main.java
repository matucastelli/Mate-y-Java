...
import Funcionalidades.lineaExpedicion.Pedido;
...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        do {
            ...
            switch (opcion) {
                ...
                case 11: agregarPedidoExpedicion(teclado, gestor, expedicion); break;
    ...
    private static void mostrarMenu() {
        ...
        System.out.println("11. Agregar pedido a linea de expedicion");
        System.out.println("12. Despachar proximo pedido");
    ...
    private static void agregarPedidoExpedicion(Scanner teclado, gestorInventario gestor, lineaExpedicion expedicion) {
        System.out.print("Codigo del producto: ");
        String codigo = teclado.nextLine();
        Producto producto = gestor.buscarProducto(codigo);
    ...
    private static void cargarDatosDePrueba(gestorInventario gestor, registroTrazabilidad trazabilidad, grafoAlmacen grafo) {
        ...
        // Mapa del almacen: pasillos y sus conexiones
